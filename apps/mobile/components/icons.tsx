...
import { UploadSimple as UploadSimpleBase } from "phosphor-react-native/src/icons/UploadSimple";
...
export const UploadSimple = withDefaultWeight(UploadSimpleBase, "UploadSimple");
